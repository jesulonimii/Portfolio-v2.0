<template>
  <main class="bg-gray-800 px-0 lg:px-20">
    ...
    <!-- Projects -->
    <div id="portfolio" class="h-full min-h-[60vh] w-full flex flex-col items-center text-white">

      <h2 class="font-ubuntu font-bold text-4xl mt-12 w-fit h-fit">Portfolio</h2>
      <p class="text-gray-400 mt-2">See some of my previous work!</p>

      <div class="w-full my-12 lg:px-16 flex flex-col md:grid m-auto md:grid-cols-2 md:gap-4 lg:grid-cols-3 lg:gap-8">

        <ProjectItem title="Link Qr" stack-used="Java + PHP" link="/portfolio/linkQr"
        ...
        <ProjectItem title="Aprihive App" stack-used="Java + Kotlin + NodeJs + Firebase" link="/portfolio/aprihive"
        ...
        <ProjectItem title="Reasonate" stack-used="Illustrator" link="/portfolio/reasonate"
...
<!--        <ProjectItem title="Dutyist" stack-used="Illustrator" link="/portfolio/dutyist"
        ...
        <ProjectItem title="House Of Jemima" stack-used="Html + Css + Bootstrap" link="/portfolio/hoj"
                     img-src="hoj.png"
                     description="Website design for House of Jemima. A beauty store located in Lagos, Nigeria."
                     type="Website Development"/>

        <ProjectItem title="Themelite" stack-used="Java" link="/portfolio/themelite"
                     img-src="themelite.png"
                     description="Android Library for quick implementation of dark theme in natiive android apps."
                     type="Android Library"/>

        <ProjectItem title="BYG App" stack-used="Java + PHP + MySql" link="/portfolio/byg"
                     img-src="byg.png"
...
<!--        <ProjectItem title="Edgewood College" stack-used="HTML + Tailwind CSS + NodeJs" link="/portfolio/edgewood-website"
        ...
        <ProjectItem title="Upskill" stack-used="Adobe After Effects" link="/portfolio/upskill"
        ...
        <ProjectItem title="Aprihive" stack-used="Adobe After Effects" link="/portfolio/aprihive"
        ...
        <ProjectItem title="Target" stack-used="Adobe After Effects" link="/portfolio/target"
                     img-src="target logo animation.mp4"
                     description="Logo Animation for Target. A retail company based in the US. (Not Contracted)"
                     type="Logo Animation" :video="true"/>

        <ProjectItem title="Edgewood College" stack-used="Adobe After Effects" link="/portfolio/ewc-logo"
                     img-src="Edgewood-logo-animation.mp4"
                     description="Logo Animation for Edgewood College. A sixth form college located in Lekki, Nigeria. "
                     type="Logo Animation" :video="true"/>

        <ProjectItem title="NGD" stack-used="Adobe After Effects" link="/portfolio/ngd"
